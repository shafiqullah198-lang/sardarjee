  ...
  if (authLoading) {
    return (
      <main className="min-h-[60vh] px-4 py-16">
        <div className="mx-auto max-w-3xl rounded-[2rem] border border-[#e4d5c4] bg-[#fffaf3]/90 p-8 text-center shadow-xl shadow-[#7d0020]/8">
  ...
  if (!isAuthenticated || !currentUser) {
    return (
      <main className="min-h-[70vh] bg-[linear-gradient(135deg,#fff8ee_0%,#f7efe3_52%,#fffdf8_100%)] px-4 py-16">
        <section className="mx-auto max-w-2xl rounded-[2rem] border border-[#e4d5c4] bg-[#fffaf3]/90 p-8 text-center shadow-xl shadow-[#7d0020]/8 sm:p-10">
          <img src={sardarjeeLogo} alt="Sardar-G Fabrics" className="mx-auto h-16 w-16 rounded-2xl object-cover" />
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            ...
            <Link to={ROUTES.signup} className="rounded-full border border-[#7d0020]/20 bg-[#fff8ee] px-6 py-3 text-[11px] font-extrabold uppercase tracking-[0.18em] text-[#7d0020]">
              Create Account
            </Link>
          </div>
        </section>
  ...
  return (
    <main className="min-h-[70vh] bg-[radial-gradient(circle_at_top_left,rgba(201,160,96,0.2),transparent_28%),linear-gradient(135deg,#fff8ee_0%,#f7efe3_52%,#fffdf8_100%)] px-4 py-10 sm:px-6 sm:py-14">
      <section className="mx-auto max-w-3xl">
        <div className="rounded-[2rem] border border-[#e4d5c4] bg-[#fffaf3]/90 p-7 text-center shadow-xl shadow-[#7d0020]/8 sm:p-10">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Link to={ROUTES.home} className="inline-flex items-center justify-center gap-2 rounded-full px-6 py-3 text-center text-[11px] font-extrabold uppercase tracking-[0.18em] text-white shadow-md shadow-[#7d0020]/14 transition hover:brightness-110 hover:-translate-y-0.5 active:scale-95" style={{ background: CRIMSON }}>
              <ShoppingBag className="h-4 w-4" />
              Continue Shopping
            </Link>
            <Link to={ROUTES.logout} className="inline-flex items-center justify-center gap-2 rounded-full border border-[#7d0020]/20 bg-[#fff8ee] px-6 py-3 text-center text-[11px] font-extrabold uppercase tracking-[0.18em] text-[#7d0020]">
