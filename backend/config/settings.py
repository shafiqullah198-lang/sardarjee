...
CSRF_COOKIE_SECURE = True
SESSION_COOKIE_DOMAIN = ".sardargfabric.com"
CSRF_COOKIE_DOMAIN = ".sardargfabric.com"
...
CACHES = {
    "default": {
        ...
        "LOCATION": "premium-shop-cache",
    }
}

# Google OAuth — used by GoogleAuthView to verify customer ID tokens
